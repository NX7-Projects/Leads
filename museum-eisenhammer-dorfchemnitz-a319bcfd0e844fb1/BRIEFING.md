...
- **Objekt:** Museum Eisenhammer Dorfchemnitz
- **Ort:** Dorfchemnitz (Erzgebirge)
- **Bisherige Website:** http://www.eisenhammer-dorfchemnitz.de/
- **Anlass:** Technisches Denkmal von hohem Rang: wasserkraftbetriebenes Hammerwerk, Ersterwaehnung 1365, laut eigener Startseite einer der aeltesten Handwerksbetriebe Sachsens. 4,8★ bei 118 Google-Bewertungen - Besucherzuspruch hoch, Webauftritt roh. Bedeutung/Auftritt-Kontrast passt exakt zur Kampagne.
- **Zielordner im Repo:** museum-eisenhammer-dorfchemnitz-a319bcfd0e844fb1
- **Spaetere Adresse:** https://nx7-projects.github.io/Leads/museum-eisenhammer-dorfchemnitz-a319bcfd0e844fb1/

## 2. Ist-Stand und Messlatte

Befund zur bisherigen Seite (aus der Recherche, MATERIAL):

> Startseite nur ueber http erreichbar (kein TLS), Baukasten-Slider mit kryptischen Bildplatzhaltern ("7980w38861w388604919"), Cookie-Hinweis ohne echte Einwilligungssteuerung. Oeffnungszeiten, Preise und Kontakt nicht auf der Startseite, sondern hinter Unterseiten-Link versteckt; keine strukturierten Besucherinfos, kein erkennbares Mobil-/SEO-Konzept.

**Die Abnahme misst genau eine Frage:** Sieht die neue Seite besser aus als http://www.eisenhammer-dorfchemnitz.de/?
...
- Die Seite erzaehlt beim Scrollen eine Geschichte statt Informationen zu stapeln - aber finde DEINE Dramaturgie fuer DIESES Haus. "Ankommen, Entdecken, Planen, Besuchen" ist ein Beispiel, keine Vorgabe: nutze es nicht woertlich als Abschnitts-Namen, erfinde die Abschnitte und ihre Reihenfolge aus dem, was dieses Haus besonders macht. Zwei Seiten derselben Kampagne duerfen NIE dieselbe Abschnittsfolge oder dieselben Abschnitts-Namen haben.
...
3. **Sieht sie besser aus als http://www.eisenhammer-dorfchemnitz.de/?** - das ist das eigentliche Kriterium.
